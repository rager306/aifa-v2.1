...
Проект использует [Renovate Bot](https://github.com/renovatebot/renovate) для автоматизации обновлений зависимостей.

### Автоматические обновления
- ✅ **Patch updates**: Автомерж при passing CI
- ✅ **Minor updates**: Группируются в один PR
- ✅ **Major updates**: Требуют ручного review
- ✅ **Security updates**: Создаются немедленно

### Расписание
- **Обычные обновления**: Понедельник 04:00 UTC
- **Security patches**: Немедленно
- **Major updates**: Первый понедельник месяца

### Управление
```bash
# Проверить Dependency Dashboard
# https://github.com/aifa-agi/aifa-v2.1/issues (ищите issue с 🤖)

# Игнорировать обновление
# Закройте PR с комментарием: @renovate ignore

# Ручной запуск
# Поставьте галочку в Dependency Dashboard
```

Подробнее: [`doc/RENOVATE.md`](doc/RENOVATE.md)
